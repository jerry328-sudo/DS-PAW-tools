...
[ -z "`echo $vasp_std`" ] && vasp_std="mpirun -np 96 /path-to-your-vasp/vasp_std"
[ -z "`echo $vasp_gam`" ] && vasp_gam="mpirun -np 96 /path-to-your-vasp/vasp_gam"
[ -z "`echo $vasp_ncl`" ] && vasp_ncl="mpirun -np 96 /path-to-your-vasp/vasp_ncl"
